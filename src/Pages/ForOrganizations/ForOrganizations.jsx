        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className={`transition-all duration-700 delay-200 ease-out ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="grid grid-cols-2 gap-4">
              {[
                { value: '4 days',  label: 'Avg. Time to Match',      sub: 'vs. 6–8 weeks traditional', bg: 'bg-[#ff8000]',              text: 'text-white' },
    ...
    <section className="py-16 sm:py-24 bg-gray-50" ref={ref}>
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-12 transition-all duration-700 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          <p className="font-body text-[#ff8000] font-semibold text-xs tracking-widest uppercase mb-3">Cost Savings Calculator</p>
          <h2 className="font-body text-3xl sm:text-4xl font-bold text-[#1a2744] mb-3">See What You Save</h2>
        ...
        <div className={`bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden transition-all duration-700 delay-100 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
          ...
          <div className="p-6 sm:p-8 border-b border-gray-100">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="font-body text-2xl font-bold text-[#ff8000]">{employees}</span>
            </div>
            <input
              ...
              style={{ background: `linear-gradient(to right, #ff8000 ${(employees - 1) / 9 * 100}%, #e5e7eb ${(employees - 1) / 9 * 100}%)` }}
            />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-gray-100">
            {[
              ...
              { label: 'Your Annual Saving', value: `€${savings.toLocaleString()}`,     sub: `${pct}% cost reduction`,     color: 'text-[#ff8000]', bg: 'bg-orange-50/60' },
            ].map(col => (
              <div key={col.label} className={`p-6 sm:p-8 text-center ${col.bg}`}>
                ...
                <p className={`font-body text-3xl sm:text-4xl font-bold ${col.color} mb-1`}>{col.value}</p>
  ...
  return (
    <div className={`flex gap-4 sm:gap-5 transition-all duration-500 ${inView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
      ...
      <div className="pb-6 sm:pb-8 flex-1 min-w-0">
        <h3 className="font-body text-lg font-bold text-white mb-1.5">{title}</h3>
...
const ORG_BENEFITS = [
  {
    emoji: <FaClock className="text-[#ff8000]" />,
  ...
  {
    emoji: <FaBriefcase className="text-[#ff8000]" />,
  ...
  {
    emoji: <FaClipboardList className="text-[#ff8000]" />,
  ...
  {
    emoji: <FaHandshake className="text-[#ff8000]" />,
  ...
  {
    emoji: <FaChartLine className="text-[#ff8000]" />,
  ...
  {
    emoji: <FaGlobeEurope className="text-[#ff8000]" />,
...
const SCORES = [
  { label: 'Talent Readiness',       score: 75, color: 'bg-[#ff8000]' },
...
const WHO_ITS_FOR = [
  {
    emoji: <FaIndustry className="text-[#ff8000]" />,
    label: 'Manufacturing & Logistics'
  },
  {
    emoji: <FaLaptopCode className="text-[#ff8000]" />,
    label: 'Tech & Digital'
  },
  {
    emoji: <FaHospital className="text-[#ff8000]" />,
    label: 'Healthcare & Social Services'
  },
  {
    emoji: <FaLeaf className="text-[#ff8000]" />,
    label: 'Agriculture & Green Transition'
  },
  {
    emoji: <MdOutlineEngineering className="text-[#ff8000]" />,
    label: 'Construction & Engineering'
  },
  {
    emoji: <FaUniversity className="text-[#ff8000]" />,
    label: 'Public Sector & Municipalities'
  },
  {
    emoji: <FaGraduationCap className="text-[#ff8000]" />,
    label: 'Education & Research'
  },
  {
    emoji: <FaShoppingCart className="text-[#ff8000]" />,
...
const ORG_TESTIMONIALS = [
  {
    emoji: <FaUserTie className="text-[#ff8000]" />,
    quote:
  ...
  {
    emoji: <FaBuilding className="text-[#ff8000]" />,
    quote:
...
export default function ForOrganizations() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section className="py-16 sm:py-24 bg-white" ref={benefitsRef}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-12 transition-all duration-700 ${benefitsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
            <p className="font-body text-[#ff8000] font-semibold text-xs tracking-widest uppercase mb-3">Why Spark</p>
            <h2 className="font-body text-3xl sm:text-4xl font-bold text-[#1a2744] mb-3">What You Get as a Partner</h2>
      ...
      {/* ── Process (dark) ── */}
      <section className="py-16 sm:py-24 bg-[#1c244b]" ref={stepsRef}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">

            <div className={`transition-all duration-700 ${stepsInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-6'}`}>
              <p className="font-body text-[#ff8000] font-semibold text-xs tracking-widest uppercase mb-3">Our Process</p>
              <h2 className="font-body text-3xl sm:text-4xl font-bold text-white leading-tight mb-5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            <div className={`transition-all duration-700 ${whoInView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-6'}`}>
              <p className="font-body text-[#ff8000] font-semibold text-xs tracking-widest uppercase mb-3">Industries We Serve</p>
              ...
              <Link to="/contact"
                className="inline-flex items-center gap-2 px-6 py-3 bg-[#1c244b] text-white text-sm font-semibold font-body rounded-full hover:bg-[#243358] hover:shadow-md hover:-translate-y-0.5 transition-all duration-200">
            ...
            <div className="bg-[#1c244b] rounded-2xl overflow-hidden">
              <div className="p-6 sm:p-8">
                <div className="flex flex-col sm:flex-row sm:items-start gap-5 mb-8">
                  <div className="w-12 h-12 rounded-2xl bg-[#ff8000]/20 border border-[#ff8000]/30 flex items-center justify-center flex-shrink-0">
                    <svg className="w-6 h-6 text-[#ff8000]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                    </svg>
                  </div>
                  <div>
                    <p className="font-body text-[#ff8000] font-semibold text-xs tracking-widest uppercase mb-1">Pilot Program</p>
                    <h2 className="font-body text-2xl sm:text-3xl font-bold text-white leading-tight">
