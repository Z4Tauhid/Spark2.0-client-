    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl font-bold text-[#1a2744]">Welcome back</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
          ...
          <p className="text-center font-body text-sm text-gray-500 mt-6">
            No account? <Link to="/register" className="text-[#E85D26] font-semibold hover:underline">Get started</Link>
          </p>
        </div>
      </div>
    </div>
