...
const ARTICLES = [
  {
    ...
    excerpt: 'We are opening our expanded pilot program to a new cohort of organizations in the region. The program offers full placement support, EOR services through Vonk, and access to our growing pool of pre-screened young professionals — at zero administrative risk.',
    date: 'June 2, 2025',
    readTime: '4 min read',
    tag: 'Pilot Program',
  ...
  },
  {
    ...
    excerpt: 'Data from our completed placements shows that trainees who complete a 12–24 month structured traineeship are 3x more likely to remain with the employer beyond the initial contract. We break down the reasons why — and what organizations can do to maximise retention.',
    date: 'May 8, 2025',
    readTime: '7 min read',
    tag: 'Insight',
  ...
  },
  {
    ...
    excerpt: 'We are excited to deepen our partnership with Vonk, Europe\'s leading Employer of Record provider. Through this collaboration, organizations that partner with Spark can now place trainees with zero administrative burden — Vonk handles contracts, payroll, and compliance.',
    date: 'March 15, 2025',
    readTime: '4 min read',
    tag: 'Partnership',
    tagColor: 'bg-[#ff8000]/10 text-[#ff8000]',
