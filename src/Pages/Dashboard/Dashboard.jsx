...
const TRAINEE_STATS = [
  ...
  { label: 'Profile Completion', value: '70%', sub: 'Add skills to reach 100%', color: 'bg-orange-50 text-[#ff8000]', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/> },
...
const TRAINEE_ACTIONS = [
  { title: 'Browse Open Roles',       desc: 'See all 1,284+ open trainee positions in the region.',          to: '/for-trainees',        accent: 'bg-[#1c244b]', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/> },
  { title: 'Complete Your Profile',   desc: 'A complete profile gets matched faster. Add skills and bio.',   to: '/dashboard',           accent: 'bg-[#ff8000]', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/> },
