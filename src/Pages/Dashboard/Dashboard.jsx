  ...
  return (
    <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm flex items-start gap-4">
      ...
      <div className="min-w-0">
        <p className="font-body text-2xl font-bold text-[#1a2744] leading-none">{value}</p>
...
function ActionCard({ title, desc, to, icon, accent }) {
  return (
    <Link to={to}
      ...
      <svg className="w-4 h-4 text-gray-300 group-hover:text-[#ff8000] group-hover:translate-x-0.5 transition-all duration-200 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const ORG_STATS = [
  ...
  { label: 'Candidates in Review', value: '6', sub: '3 shortlisted',           color: 'bg-orange-50 text-[#ff8000]', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/> },
...
const ORG_ACTIONS = [
  { title: 'Post a Traineeship',     desc: 'Add a new traineeship role to the Spark platform.',              to: '/for-organizations',   accent: 'bg-[#ff8000]', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4"/> },
  { title: 'View Candidates',        desc: 'Review profiles of trainees actively looking for placements.',   to: '/for-organizations',   accent: 'bg-[#1c244b]', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z"/> },
...
const ORG_ACTIVITY = [
  { text: 'A new applicant matched your "Junior Developer Traineeship" posting', time: '2 hours ago', color: 'bg-blue-50 text-blue-500', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/> },
  { text: 'Spark reviewed your listing — ready to publish', time: 'Yesterday', color: 'bg-green-50 text-green-500', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/> },
  { text: '3 new candidates matching your criteria joined the platform', time: '3 days ago', color: 'bg-orange-50 text-[#ff8000]', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/> },
  { text: 'Welcome to Spark Traineeships! Post your first listing to get matched with trainees.', time: '1 week ago', color: 'bg-purple-50 text-purple-500', icon: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/> },
];
...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* ── Top banner ── */}
      <div className="bg-[#1c244b] relative overflow-hidden">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-3.5 py-1 mb-3">
                ...
                <span className="font-body text-white/70 text-[11px] font-semibold tracking-widest uppercase">
                  {isOrg ? 'Organization Dashboard' : 'Admin Dashboard'}
                </span>
              </div>
              <h1 className="font-body text-2xl sm:text-3xl font-bold text-white leading-tight">
                Welcome back, {user?.firstName}!
              </h1>
              <p className="font-body text-white/55 text-sm mt-1">
                {isOrg
                  ? 'Manage your listings, review candidates, and track placements.'
                  : 'Oversee the platform, manage users, and monitor activity.'}
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col">
            <p className="font-body text-[#ff8000] font-semibold text-xs tracking-widest uppercase mb-5">Your Profile</p>

            {/* Avatar */}
            <div className="flex items-center gap-4 mb-6">
              <div className="w-14 h-14 rounded-2xl bg-[#1c244b] flex items-center justify-center flex-shrink-0">
                <span className="font-body text-xl font-bold text-white">
                  {user?.firstName?.[0]}{user?.lastName?.[0]}
                </span>
              </div>
              <div className="min-w-0">
                <p className="font-body font-bold text-[#1a2744] text-base leading-tight truncate">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="font-body text-xs font-bold text-[#ff8000]">{completion}%</span>
              </div>
              <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden">
                <div className="h-full bg-[#ff8000] rounded-full transition-all duration-1000"
            ...
            <button className="mt-5 w-full py-2.5 border-2 border-[#1a2744] text-[#1a2744] font-body text-xs font-semibold rounded-full hover:bg-[#1c244b] hover:text-white transition-all duration-200">
              Edit Profile
            </button>
          </div>
          ...
          <div className="lg:col-span-2">
            <p className="font-body text-[#ff8000] font-semibold text-xs tracking-widest uppercase mb-4">Quick Actions</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <p className="font-body text-[#ff8000] font-semibold text-xs tracking-widest uppercase mb-5">Recent Activity</p>
            <div className="divide-y divide-gray-50">
              {ORG_ACTIVITY.map((a, i) => <ActivityRow key={i} {...a} />)}
            </div>
          </div>

          {/* Intelligence platform teaser */}
          <div className="bg-[#1c244b] rounded-2xl p-6 relative overflow-hidden flex flex-col">
            <div className="absolute inset-0 opacity-[0.05]"
              style={{ backgroundImage: 'radial-gradient(circle,#fff 1px,transparent 1px)', backgroundSize: '24px 24px' }} />
            <div className="relative flex-1 flex flex-col">
              <div className="w-10 h-10 rounded-xl bg-[#ff8000]/20 border border-[#ff8000]/30 flex items-center justify-center mb-4">
                <svg className="w-5 h-5 text-[#ff8000]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="font-body text-xl font-bold text-white mb-3 leading-tight">
              ...
              <div className="space-y-2">
                {['Labour market heatmaps', 'Real-time job counters', 'Career diagnostic tool', 'Regional impact tracker'].map(f => (
                  <div key={f} className="flex items-center gap-2.5">
                    <span className="w-1.5 h-1.5 rounded-full bg-[#ff8000] flex-shrink-0" />
