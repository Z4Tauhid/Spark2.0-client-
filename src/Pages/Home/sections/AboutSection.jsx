      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className={`relative transition-all duration-700 ease-out ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>
            ...
            {/* orange corner badge */}
            <div className="absolute -bottom-5 -right-5 w-[88px] h-[88px] rounded-2xl bg-[#ff8000] flex items-center justify-center shadow-xl">
              <div className="text-center">
                <p className="font-body text-2xl font-bold text-white leading-none">5+</p>
          ...
          <div className={`transition-all duration-700 delay-200 ease-out ${inView ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'}`}>
            <p className="font-body text-[#ff8000] font-semibold text-xs tracking-widest uppercase mb-3">About Spark</p>
          ...
          {[
            {
              ...
              cta: 'Learn More', to: '/for-trainees', accent: 'bg-[#1c244b]',
            ...
            },
            {
              ...
              cta: 'Learn More', to: '/for-organizations', accent: 'bg-[#ff8000]',
            ...
            <div key={card.title}
              className="group relative bg-[#1c244b] rounded-2xl overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
              ...
              <div className="p-7">
                ...
                <h3 className="font-body text-xl font-bold text-white mb-3">{card.title}</h3>
                <p className="font-body text-white/60 text-sm leading-relaxed mb-6">{card.desc}</p>
                <Link to={card.to}
                  className="inline-flex items-center gap-2 text-sm font-semibold font-body text-[#ff8000] group-hover:gap-3 transition-all duration-200">
                  {card.cta}
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                  </svg>
